# services/audit_service/app/database.py
"""
Audit Service Database Configuration

This module configures the SQLAlchemy database connection for the Audit Service.
...
# SQLite database URL - creates/connects to audit.db in the current directory
